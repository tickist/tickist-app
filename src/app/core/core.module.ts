...
import * as fromSortTasks from './reducers/sort-tasks.reducer';
...
import * as fromFilterTasks from '../tasks/main-filters-tasks.reducer';
import * as fromAssignedToFiltersTasks from '../tasks/assigned-to-filters-tasks.reducer';
import * as fromEstimateTimeFiltersTasks from '../tasks/estimate-time-filters-tasks.reducer';
import * as fromTagsFiltersTasks from '../tasks/tags-filters-tasks.reducer';
