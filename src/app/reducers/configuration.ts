...
export function leftSidenavVisibility (state: any = {'position': 'start', 'mode': 'side', 'open': true}, action: configurationActions.Actions) {
  switch (action.type) {
...
export function rightSidenavVisibility (state: any = {'position': 'end', 'mode': 'side', 'open': true}, action: configurationActions.Actions)  {
  switch (action.type) {
