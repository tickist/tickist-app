...
describe("TasksTreeViewMainViewComponent", () => {
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            imports: [TickistMaterialModule, TickistSingleTaskModule, StoreModule.forRoot({}), IconsModule, RouterTestingModule],
            declarations: [TasksTreeViewComponent, MockComponent(ProjectTreeComponent), MockComponent(AddTaskTreeViewComponent)],
        }).compileComponents();
    }));
