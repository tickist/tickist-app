...
export class MockConfigurationService extends SpyObject {
    ...
    constructor() {
        ...
        //     }
        // };
        this.loadConfiguration = this.spy("loadConfiguration").and.returnValue(
            this.mockConfiguration
        );
        this.fakeResponse = null;
        this.responseSuccess = true;
        this.activeDateElement$ = this.spy("activeDay$").and.returnValue(this);
        this.offlineModeNotification$ = this.spy(
            "offlineModeNotification$"
        ).and.returnValue(of(this.fakeResponse));
        this.detectApiError$ = this.spy("detectApiError$").and.returnValue(
            of(this.fakeResponse)
        );
        this.leftSidenavVisibility$ = of(this.fakeResponse);
        this.rightSidenavVisibility$ = of(this.fakeResponse);
        this.addTaskComponentVisibility$ = of(
            this.addTaskComponentVisibilityResponse
        );
