...
export {onUpdateProject, createUpdateProjectNotifications} from './app/projects/on-update-project';
...
export {onUpdateTask, createUpdateTaskNotifications} from './app/tasks/on-update-task';
